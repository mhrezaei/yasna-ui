...
<div class="row footer-info">
    <div class="col-md-3 col-sm-4 col-xs-12">
        <?php echo $__env->make('yasna.contact-info',[
    ...
    <div class="col-md-3 col-sm-4 col-xs-6">
       <?php echo $__env->make('yasna.contact-link-list',[
    ...
    <div class="col-md-3 col-sm-12">
        <?php echo $__env->make('yasna.button-language', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
</div>
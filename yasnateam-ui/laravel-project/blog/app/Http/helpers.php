...
function hashid_encrypt($id, $connection = 'posts')
{
	return Hashids::connection($connection)->encode($id);
}

function hashid_decrypt($hash, $connection = 'posts')
{
    return Hashids::connection($connection)->decode($hash);
}

function hashid_decrypt0($hash, $connection = 'posts')
{
...
function hashid($string , $connection= 'posts')
{
...
function isIndex()
{
    ...
    return strpos($route['controller'], 'YasnaController@index');
}